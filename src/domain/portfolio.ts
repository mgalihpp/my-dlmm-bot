...
export type OpenPortfolioTotals = Schema.Schema.Type<
	typeof OpenPortfolioTotals
>;
...
export type OpenPortfolioResponse = Schema.Schema.Type<
	typeof OpenPortfolioResponse
>;
...
export const ClosedPool = Schema.Struct({
	...
	totalDepositSol: Schema.optional(Schema.String),
	totalWithdrawalSol: Schema.optional(Schema.String),
	totalFeeSol: Schema.optional(Schema.String),
	pnlUsd: Schema.String,
...
export type ClosedPortfolioResponse = Schema.Schema.Type<
	typeof ClosedPortfolioResponse
>;
