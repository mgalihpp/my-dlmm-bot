...
import { type ActionEntry, SessionStore } from "../services/SessionStore.js";
...
export function registerAction(
	...
	return runtime.runSync(
		Effect.flatMap(SessionStore, (s) =>
			s.registerAction(poolAddress, positionPubkey),
		),
	);
}
...
export function resolveAction(id: string): ActionEntry | null {
	return Option.getOrNull(
		runtime.runSync(Effect.flatMap(SessionStore, (s) => s.resolveAction(id))),
	);
}
