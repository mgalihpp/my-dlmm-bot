...
2. Check for Node.js 20 or newer. If it is missing, install it using the normal package manager for this operating system.
3. Read README.md, docs/ai-agent.md, docs/config-reference.md, docs/troubleshooting.md, and AGENTS.md.
4. Run npm install and npm run build. Diagnose and fix installation or build errors instead of stopping at the first error.
...
9. Run npm run check, npm run typecheck, and npm test. Fix failures and rerun the checks.
10. Explain how to run npm run bot, then use /agent start and /agent status in Telegram.
